...
// tlslayer.c exports libssl compatibility APIs. Unlike tlslayer low-level apis,
// the SSL_* interface // is blocking! (or depending of the underling socket).
// //
// =================================================================================================
// //

// optional callback function for peer certificate verify
int verify(struct TLSContext *context,
...
int main(int argc, char *argv[]) {
  ...
  // ===========================================================================
  // // IMPORTANT NOTE: SSL_new(clientssl) MUST never be called SSL_CTX_new
  // returns a SSL handle, instead of a SSL_CTX object (like libssl)
  // ===========================================================================
  // //
